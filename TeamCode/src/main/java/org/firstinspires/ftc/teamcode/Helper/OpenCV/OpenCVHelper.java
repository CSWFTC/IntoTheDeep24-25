  ...
  private static class VisionPipeline extends OpenCvPipeline {
    ...
    public Mat processFrame(Mat input) {
      ...
      if (targetDetected) {
        ...
        Imgproc.line(input, new org.opencv.core.Point(centerX, 0), new org.opencv.core.Point(centerX, input.height()),
        ...
        String text = "Width: " + largestRect.width + " Height: " + largestRect.height + " Distance: "
            + String.format("%.2f", distance) + " in";
